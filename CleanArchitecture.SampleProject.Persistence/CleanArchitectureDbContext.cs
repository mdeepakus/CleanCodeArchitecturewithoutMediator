    ...
    public class CleanArchitectureDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                Description = "Join Danny D. for his farwell tour across 15 continents. Danny really needs no introduction since he has already mesmerized the world with his banjo.",
                ImageUrl = "https://cdn.britannica.com/w:400,h:300,c:crop/97/67497-004-6A76804D/banjo-Musician-lute.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://img.freepik.com/free-photo/party-night-club-disc-dj-entertainment-with-edm-dance-music-mixer-players-with-lighting-e_29393-198.jpg?size=626&ext=jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://images.hindustantimes.com/rf/image_size_630x354/HT/p2/2020/09/27/Pictures/_4faaedbe-003a-11eb-ac80-07fcacbe9f14.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://cdn.iconscout.com/icon/free/png-256/confrence-155102.png",
                CategoryId = conferenceGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://d2tgq9yjy8gjjk.cloudfront.net/_imager/files/121968/SIX-Sheffield-Web-Jpeg-2500x1380_6fdf03a824c15bd335fd197d290320b4.jpeg",
                CategoryId = musicalGuid
            });
